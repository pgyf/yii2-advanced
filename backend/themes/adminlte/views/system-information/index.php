...
use backend\themes\adminlte\assets\SystemInformationAsset;
...
//    ['depends' => ['\yii\web\JqueryAsset', '\common\lib\assets\Flot', '\yii\bootstrap\BootstrapPluginAsset']]
//) 
?>
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <dl class="dl-horizontal">
                        ...
                        <dd><?php echo \yii\helpers\Html::encode($provider->getOsRelease()) ?></dd>

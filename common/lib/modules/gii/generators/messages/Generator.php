...
namespace common\lib\modules\gii\generators\messages;
...
{
    public $db = 'db';
    public $ns = 'common\messages\zh-CN\common\models'; //app\models
    public $tableName;
    public $modelClass;
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            ...
            [[ 'baseClass', 'queryNs', 'queryBaseClass'], 'match', 'pattern' => '/^[\w\\\\]+$/', 'message' => 'Only word characters and backslashes are allowed.'],

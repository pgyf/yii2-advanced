...
namespace common\lib\modules\gii\generators\model;
...
{
    public $db = 'db';
    public $ns = 'common\models\table'; //app\models
    public $tableName;
    public $modelClass;
    public $baseClass = 'common\lib\base\ActiveRecord'; //yii\db\ActiveRecord
    public $generateRelations = true;
    public $generateLabelsFromComments = false;
    public $useTablePrefix = true; //false
    public $useSchemaName = true;
    public $generateQuery = true; //false
    public $queryNs = 'common\models\query'; //app\models
    public $queryClass;
    public $queryBaseClass = 'common\lib\base\ActiveQuery'; //yii\db\ActiveQuery

    public $messageCategory = 'common/models/';
     ...
     * @return string
     */
    public function generateString1($tableName, $string = '', $placeholders = [])
    {
        ...
        if ($this->enableI18N) {
            ...
            $str = "Yii::t('" . $this->messageCategory . $tableName . "', '" . $string . "'" . $ph . ")";
        } else {
